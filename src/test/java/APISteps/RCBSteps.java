...
public class RCBSteps extends BaseTest {
    ...
    @Step("Read the content from the json file at {0} and read the content from the file using jaywaypath {1}")//every method annotated with step gets mentioned in the report
